...
int pacman (int l, int c, char map[l][c], int pX, int pY) {
    int fX = 0, fY = 0, foodsEaten = 0;
    int checked[l][c];
...
void print_map(int l, int c, char map[l][c], int foodsEaten) {
...
int main (void) {
    ...
    foodsEaten = pacman(l, c, map, pX, pY);
    
    //printing the map
    print_map(l,c, map, foodsEaten);
